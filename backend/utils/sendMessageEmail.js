...
<head>
  ...
  <title>New Message on OMNI Chat</title>
</head>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f0f2f5;padding:40px 0;">
        ...
        <table width="520" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td align="center" style="background-color:#6366f1;padding:32px 40px;">
              <h1 style="margin:0;color:#ffffff;font-size:24px;font-weight:700;letter-spacing:0.5px;">OMNI Chat</h1>
          ...
          <tr>
            <td align="center" style="background-color:#f9fafb;border-top:1px solid #e5e7eb;padding:18px 40px;">
              <p style="margin:0;font-size:12px;color:#9ca3af;">
                You're receiving this because email notifications are enabled on your OMNI Chat account.
              </p>
              <p style="margin:4px 0 0;font-size:12px;color:#9ca3af;">
                To disable, visit <a href="${FRONTEND_URL}/user/profile" style="color:#6366f1;">Settings → Notifications</a>.
              </p>
              <p style="margin:8px 0 0;font-size:12px;color:#9ca3af;">
                &copy; ${new Date().getFullYear()} OMNI Chat
              </p>
            </td>
          </tr>
    ...
    transporter
        .sendMail({
            ...
            to: receiver.email,
            subject: `💬 ${sender.name} sent you a message on OMNI Chat`,
            html,
        })
        .catch((err) => {
